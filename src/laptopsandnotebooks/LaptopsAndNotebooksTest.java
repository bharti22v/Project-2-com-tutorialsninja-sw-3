 ...
 */
    ...
    public void verifyThatUserPlaceOrderSuccessfully() throws InterruptedException {
        ...
        sendTextToElement(By.id("input-payment-firstname"), "Bharti");
        sendTextToElement(By.id("input-payment-lastname"), "Kumawat");
        sendTextToElement(By.id("input-payment-email"), "sunil123@gmail.com");
        sendTextToElement(By.id("input-payment-telephone"), "074444444443");
        sendTextToElement(By.id("input-payment-address-1"), "Eden building");
        sendTextToElement(By.id("input-payment-city"), "Reading");
        sendTextToElement(By.id("input-payment-postcode"), "HA7se");
        selectByValueFromDropDown(By.id("input-payment-zone"), "4672");//selectByValueFromDropDown(By.id("input-payment-country"), "222");
