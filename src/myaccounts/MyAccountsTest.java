 ...
 */
    ...
    public void verifyThatUserRegisterAccountSuccessfully() {
        ...
        sendTextToElement(By.id("input-firstname"), "Bharti");//Enter First Name
        sendTextToElement(By.id("input-lastname"), "Kumawat");  //Enter Last Name
        //Enter Email
        ...
        sendTextToElement(By.id("input-telephone"), "074444444443"); //Enter Telephone
        sendTextToElement(By.id("input-password"), "MummyPapa"); //Enter Password
        sendTextToElement(By.id("input-confirm"), "MummyPapa");//Enter Password Confirm
    ...
    public void verifyThatUserShouldLoginAndLogoutSuccessfully() {
        ...
        sendTextToElement(By.id("input-email"), "sunil123@gmail.com");//Enter Email address
